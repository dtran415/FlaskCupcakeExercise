...
class CupcakeViewsTestCase(TestCase):
    ...
    def test_create_bad_cupcake(self):
        with app.test_client() as client:
            url = "/api/cupcakes"
            bad_cupcake = {
                "flavor": "Bad Flavor",
                "size": "TestSize2", #missing size
                "rating": "abc", #bad rating
                "image": "http://test.com/cupcake2.jpg"
            }
            
            resp = client.post(url, json=bad_cupcake)
    ...
    def test_update_cupcake(self):
        with app.test_client() as client:
            url = f"/api/cupcakes/{self.cupcake.id}"
            updated_cupcake = {'flavor': 'TestFlavor3'}
            ...
            # check updated cupcake also has new flavor
